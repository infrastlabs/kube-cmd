...
mkdir /ws && cd /ws
    ...
    wget -q https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize/${KUSZ_VER}/kustomize_${KUSZ_VER}_linux_amd64.tar.gz | tar -xzO kustomize  -O kustomize
    chmod +x *
    tree -h ./
